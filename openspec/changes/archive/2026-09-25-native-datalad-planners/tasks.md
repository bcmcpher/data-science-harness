...
- [x] 7.4 After archive, update the Purpose paragraphs that still name the datalad doer (`openspec/specs/datalad`, `containers`, `annotate`, `process`); deltas do not carry Purpose text
