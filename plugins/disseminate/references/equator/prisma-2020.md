...
Reporting guideline for **systematic reviews and meta-analyses**. 27 items.

Item 2 refers out to the separate *PRISMA 2020 for Abstracts* checklist, which is **not** bundled
here.
...
<https://doi.org/10.1136/bmj.n71>. Checklist PDF from <https://www.prisma-statement.org>.

**Redistribution basis:** *"The PRISMA 2020 checklists are distributed in accordance with the terms
...
(prisma-statement.org; *Copyright © 2024-2026 the PRISMA Executive*). Verified 2026-09-18.
...
Items 24a–24c (registration and protocol), 25 (support) and 27 (availability of data, code and
other materials) are answerable from `project.yaml` and the released dataset's identifier. Item 27
is the one a compendium answers well and most reviews answer badly.
